...
summon armor_stand ~0.0001 ~-0.7406250089408 ~ {NoGravity:1b,Small:1b,Invulnerable:1b,Invisible:1b,NoBasePlate:1b, Tags:[compacteur_wall_new,compacteur_texture], Passengers:[{id:falling_block,Tags:[compacteur_wall_new_blockstate],NoGravity:1b,Time:1,BlockState:{Name:"nether_bricks"}}]}
execute if score summon_shulker fb_compacteur matches 1 run summon armor_stand ~0.0002 ~-0.7406250089408 ~0.0001 {NoGravity:1b,Small:1b,Invulnerable:1b,Invisible:1b,NoBasePlate:1b, Tags:[compacteur_wall_new,compacteur_idbox], Passengers:[{id:shulker,NoAI:1b,Tags:[compacteur_wall_new_shulker],Invulnerable:1b,PersistenceRequired:1b}]}
